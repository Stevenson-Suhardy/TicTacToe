// Last Modified By: Stevenson Suhardy
...
namespace TicTacToe
{
    public partial class formTicTacToe : Form
    {
        ...
        private void SetDefaults()
        {
            ...
            isWinner = false;
            // Changing background color of the button to default
        ...
        // as long as it's the same!
            ...
            for (int index = 0; index <= squares.GetUpperBound(0); index++)
            {
                ...
                {
                    isWinner = true;
                    // Changing the color on the winning symbol buttons.
                    squares[index, 0].BackColor = Color.BlueViolet;
                    squares[index, 1].BackColor = Color.BlueViolet;
                    squares[index, 2].BackColor = Color.BlueViolet;
                }
                // Checking the columns
                else if (squares[0, index].Text != String.Empty &&
                    squares[0, index].Text == squares[1, index].Text &&
                    squares[0, index].Text == squares[2, index].Text)
                {
                    isWinner = true;
                    // Changing the color on the winning symbol buttons.
                    squares[0, index].BackColor = Color.Red;
                    squares[1, index].BackColor = Color.Red;
                    squares[2, index].BackColor = Color.Red;
                }
                ...
                squares[0, 0].Text == squares[2, 2].Text)
            {
                isWinner = true;
                // Changing the color on the winning symbol buttons.
                squares[0, 0].BackColor = Color.Snow;
                squares[1, 1].BackColor = Color.Snow;
                squares[2, 2].BackColor = Color.Snow;
            }
                ...
                squares[0, 2].Text == squares[2, 0].Text)
            {
                isWinner = true;
                // Changing the color on the winning symbol buttons.
                squares[0, 2].BackColor = Color.Snow;
                squares[1, 1].BackColor = Color.Snow;
                squares[2, 0].BackColor = Color.Snow;
            }
            // **************************************************
